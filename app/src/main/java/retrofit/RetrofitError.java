...
public class RetrofitError extends RuntimeException {
  ...
  /** Identifies the event kind which triggered a {@link retrofit.RetrofitError}. */
  public enum Kind {
   ...
   * or the generic type of the supplied {@link retrofit.Callback} parameter. {@code null} if there is no
   * response.
   *
   ...
   * supplied {@link retrofit.Callback} parameter.
   */
